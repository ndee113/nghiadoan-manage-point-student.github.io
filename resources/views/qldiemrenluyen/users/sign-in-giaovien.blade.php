  ...
  <div class="container py-5 h-100">
    <div class="row d-flex align-items-center justify-content-center h-100">
      <div class="col-md-8 col-lg-7 col-xl-6">
        <img src="/template/homepage/dist/img/teacher.png"
          class="img-fluid" alt="Phone image">
      </div>
      <div class="col-md-7 col-lg-5 col-xl-5 offset-xl-1">
      <h2 class="fw-bold mb-5">ĐĂNG NHẬP HỆ THỐNG CB-GV</h2>
      @include('qldiemrenluyen.alert')
        <form action="{{ Route('sign-in-store-gv') }}" method="post">
          <!-- Email input -->
        ...
        <div class="" style="line-height: 50px;">
          ...
          <a href="{{ Route('sign-in')}}"><i class="fa-solid fa-left-long"></i> Quay lại<i class="fa-solid far-right-long"></i></a>
        </div>
